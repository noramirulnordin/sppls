    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-3 mt-2">
            <div class="col-md-8 col-12">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="page-title mb-0 fw-bold">Tambah Kawasan</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('kawasans.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('no_permit') is-invalid @enderror"
                                    id="no_permit" name="no_permit" value="{{ old('no_permit') }}">
                                @error('no_permit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
