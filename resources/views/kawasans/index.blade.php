        ...
        <div class="row align-items-center mb-3 mt-2">
            <div class="col-md-8 col-12">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h2 class="page-title mb-0 fw-bold">Senarai Kawasan</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="{{ route('kawasans.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle me-2"></i> Tambah Kawasan</a>
                            </div>
                            <div class="col-sm-8">
        ...
        $(document).ready(function() {
            $('#products-datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'no_pendaftaran_lori',
                        name: 'no_pendaftaran_lori'
                    },
                    {
                        data: function(data) {
                            return `
                                <a href="/kawasans/${data.id}/edit" class="btn btn-warning btn-sm"><i class="mdi mdi-pencil"></i></a>
                                <button class="btn btn-danger btn-sm" onclick="deleteKawasan(${data.id})"><i class="mdi mdi-delete"></i></button>
