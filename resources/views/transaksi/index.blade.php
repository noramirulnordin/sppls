        ...
        <div class="row align-items-center mb-3 mt-2">
            <div class="col-md-8 col-12">
                <div class="d-flex align-items-center">
                    <i class="uil-bill text-primary display-5 me-3"></i>
                    <div>
                        <h2 class="page-title mb-0 fw-bold">Senarai Transaksi</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="{{ route('transaksis.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-cart-plus me-2"></i> Buat Pembelian </a>
                            </div>
                            <div class="col-sm-8">
        ...
        $(document).ready(function() {
            $('#products-datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'balak.jenis_pokok',
                        name: 'balak.jenis_pokok'
                    },
                    {
                        data: 'tarikh_dibeli',
                        name: 'tarikh_dibeli'
                    ...
                    //     data: function(data) {
                    //         return `
                //             <a href="/transaksis/${data.id}/edit" class="btn btn-warning btn-sm"><i class="mdi mdi-pencil"></i></a>
                //             <button class="btn btn-danger btn-sm" onclick="deleteTransaksi(${data.id})"><i class="mdi mdi-delete"></i></button>
                //         `;
                    //     },
                    //     name: 'action',
                    //     orderable: false,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire(
                                'Dihapus!',
                                'Transaksi telah berjaya dipadam.',
                                'success'
                            );
